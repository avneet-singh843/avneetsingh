...
const Sidebar = () => {
  ...
  useEffect(() => {
    ...
    if (width < 768) setShowContact(false);
  }, []);
  ...
  return (
    <div className="md:pb-[6vh] pb-[2vh]">
      <div
        ...
        className="relative top-0 ml-[94%] md:hidden text-[#F3D16C] right-0 mt-2 mr-2 cursor-pointer"
      >
      ...
      <div className="md:block flex w-[80%] justify-between md:w-full mx-auto">
        ...
        <div className="w-[80%] md:w-full ">
          <div className="mx-auto w-[90%] rounded-lg tracking-wide py-[0.15rem] md:mt-[3vh]">
            <p className="text-center text-[1.2rem] md:text-[1.5rem] font-[600] text-[#FAFAFA]">
              Avneet Singh
            </p>
          </div>
          <div className="bg-[#383839] mx-auto md:w-[65%] w-[55%] rounded-lg tracking-wide py-[0.15rem] mt-[1vh] md:mt-[2vh]">
            <p className="text-center text-[0.55rem] md:text-[0.75rem] font-[300] text-[#FAFAFA]">
              Software Developer
            </p>
          </div>
        </div>
      ...
      <div className="w-[70%] flex justify-between mx-auto mt-[2vh] md:mt-[6vh] text-[#D6D6D6]">
        <a
          href="https://www.linkedin.com/in/avneet-singh-7758a1227/"
          target="_blank"
        ...
        <a
          href="https://github.com/avneet-singh843"
          target="_blank"
          rel="noopener noreferrer"
        >
          <FaGithub size={20} />
        ...
        <a
          href="https://leetcode.com/u/theStark/"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a
          href="https://x.com/singhavneet317"
          target="_blank"
          rel="noopener noreferrer"
        >
