...
const Contact = () => {
  ...
  const client = new Client()
    ...
    .setProject("676aea560032606f1764");
  ...
  const handleSubmit = (e: any) => {
    ...
    if (validateDetails()) {
      ...
      const promise = databases.createDocument(
        "676aeb93002cd927bd92",
        "676aeba4000d3bb660f1",
        ID.unique(),
        {
          name: name,
          email: email,
      ...
      <div className="w-[80%] text-[#FAFAFA] bg-[#232325] mx-auto my-[4vh] md:my-[9vh] rounded-md py-4 px-4 md:px-10 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] border-[#303030] border-[1px]">
        <div className="md:flex justify-between mx-auto">
          <input
            ...
            type="text"
            name="name"
            className="bg-[#232325] border-b-2 my-4 w-[80%] border-[#383838] focus:outline-none md:w-[40%]"
          />
          <input
            value={email}
        ...
        <textarea
          ...
          name="desc"
          className="bg-[#232325] border-b-2 my-4 h-[15vh] border-[#383838] focus:outline-none w-[100%]"
        />
        <button
          onClick={(e) => {
            handleSubmit(e);
