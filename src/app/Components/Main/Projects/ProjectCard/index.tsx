...
const ProjectCard: React.FC<ProjectCardProps> = ({
  ...
  return (
    <div
      className="md:w-[30%] w-[90%] mx-auto h-[60%] relative md:my-5 my-9 hover:scale-110 transition-all duration-500"
      key={id}
    >
      <Image
        className="rounded-xl z-10 w-150 h-40"
      ...
      <div className="flex text-[#FFDB70] items-center z-30 justify-center absolute rounded-xl inset-0 bg-black bg-opacity-50">
        {liveLink != "null" && (
          <a href={liveLink} target="_blank" rel="noopener noreferrer">
            <div className="bg-[#383838] p-2 rounded-lg mr-4">
              <FaEye size={23} />
            </div>
          </a>
        )}
